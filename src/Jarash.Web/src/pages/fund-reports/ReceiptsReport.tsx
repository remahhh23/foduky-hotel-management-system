...
export function ReceiptsReport() {
  ...
  useEffect(() => {
    let list = cashTransactionService.getByType("receipt");
  ...
  return (
    <div className="rounded-lg bg-white/5 p-4">
      <h2 className="mb-4 text-lg font-bold text-green-400">عمليات القبض</h2>
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          ...
          <tbody>
            {txns.length === 0 ? (
              <tr><td colSpan={6} className="px-3 py-4 text-center text-sm text-gray-400">لا توجد عمليات قبض</td></tr>
            ) : (
              txns.map((t) => (
